...
```bash
git clone https://github.com/tristan-carter/dotfiles.git ~/dotfiles 2>/dev/null || (cd ~/dotfiles && git fetch && git reset --hard origin/main) && cd ~/dotfiles && chmod +x install.sh && ./install.sh
